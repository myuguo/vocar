...
message(STATUS "chip_bldc_driver: 4 messages, 0 services")

set(MSG_I_FLAGS "-Ichip_bldc_driver:/vocar/src/chip_bldc_driver/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/vocar/src/chip_bldc_driver/msg/Command.msg" NAME_WE)
add_custom_target(_chip_bldc_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "chip_bldc_driver" "/vocar/src/chip_bldc_driver/msg/Command.msg" "std_msgs/Header"
)

get_filename_component(_filename "/vocar/src/chip_bldc_driver/msg/Feedback.msg" NAME_WE)
add_custom_target(_chip_bldc_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "chip_bldc_driver" "/vocar/src/chip_bldc_driver/msg/Feedback.msg" "std_msgs/Header"
)

get_filename_component(_filename "/vocar/src/chip_bldc_driver/msg/Status.msg" NAME_WE)
add_custom_target(_chip_bldc_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "chip_bldc_driver" "/vocar/src/chip_bldc_driver/msg/Status.msg" "std_msgs/Header"
)

get_filename_component(_filename "/vocar/src/chip_bldc_driver/msg/Config.msg" NAME_WE)
add_custom_target(_chip_bldc_driver_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "chip_bldc_driver" "/vocar/src/chip_bldc_driver/msg/Config.msg" ""
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/chip_bldc_driver)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/chip_bldc_driver\")")
  # install generated code
  install(
